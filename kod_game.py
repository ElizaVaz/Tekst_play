...
# =================================Часть жизни кота во время бездомности
    def homeless(lives):  # Часть жизни кота во время бездомности
        if lives > 0:
            ...
            eda = input()
            while eda != "1" and eda != "2":
                print("Но-но-но! Выберете 1 или 2.")
                eda = input()
            if eda == "1":
...
# =================================Часть жизни кота во время домности
