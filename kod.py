...
print("=====================================================================================================")
print("Котик родился.")
print("Выберете изначальную судьбу: 'быть беpдомным' или 'быть домашним'")
...
def homeless():
    ...
    if eda == "1":
        ...
        print("+НАВЫК ГОТОВКИ")
        print("На запах прилетела чайка. Она тоже хочет есть и готова драться за еду! Отдать еду?")
        print("1) Нет!")
        print("2) Да")
        neda = input()
